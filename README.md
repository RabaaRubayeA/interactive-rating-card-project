...
A responsive rating component built with HTML, CSS, and JavaScript.
Features
•	Select a rating from 1 to 5
•	Prevent submission without selecting a rating
•	Display the selected rating on the thank-you page
